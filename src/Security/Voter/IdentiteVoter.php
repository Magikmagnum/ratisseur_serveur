...
class IdentiteVoter extends Voter
{
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return in_array($attribute, [self::EDIT, self::VIEW, self::DELETE])
            && $subject instanceof \App\Entity\Identite;
    }
